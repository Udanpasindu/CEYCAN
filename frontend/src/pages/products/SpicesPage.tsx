...
const SpicesPage = () => {
  ...
  useEffect(() => {
    const fetchCategoryData = async () => {
      try {
        ...
        const id = getCategoryIdByName(categories, "Spices");
        if (id) {
          setCategoryId(id);
  ...
  return (
    <ProductPageLayout
      ...
      heroImage={categoryData?.image || "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=600&h=400&fit=crop"}
      products={products}
      isLoading={loading}
    />
  );
